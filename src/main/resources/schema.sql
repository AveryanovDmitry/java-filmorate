...
CREATE TABLE IF NOT EXISTS FILM (
 ...
 CONSTRAINT FILM_FK FOREIGN KEY (RATING_ID) REFERENCES RATING(RATING_ID) ON DELETE CASCADE ON UPDATE RESTRICT
);
...
CREATE TABLE IF NOT EXISTS FILM_GENRE (
 ...
 CONSTRAINT FILM_GENRE_FK_1 FOREIGN KEY (FILM_ID) REFERENCES FILM(FILM_ID) ON DELETE CASCADE ON UPDATE RESTRICT
);
...
CREATE TABLE IF NOT EXISTS "LIKES" (
 ...
 CONSTRAINT LIKES_FK_1 FOREIGN KEY (FILM_ID) REFERENCES FILM(FILM_ID) ON DELETE CASCADE ON UPDATE RESTRICT
);
...
CREATE INDEX IF NOT EXISTS FILM_DIRECTOR_FK_1_INDEX_7 ON FILM_DIRECTOR (FILM_ID);
CREATE INDEX IF NOT EXISTS FILM_DIRECTOR_FK_INDEX_7 ON FILM_DIRECTOR (DIRECTOR_ID);
...
(
    ...
    user_id        INTEGER NOT NULL,
    timestamp      LONG,
    CONSTRAINT feed_users_user_id_fk FOREIGN KEY (user_id) REFERENCES "USER" (USER_ID) ON DELETE CASCADE
);